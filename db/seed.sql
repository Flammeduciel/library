-- Seed de démonstration cohérent pour la bibliothèque (développement local).
-- À lancer après db/schema.sql : `npm run db:seed`.
-- Comptes staff : admin@biblio.fr / superadmin123 et biblio@biblio.fr / biblio123
-- Adhérents : mot de passe commun "adherent123".
